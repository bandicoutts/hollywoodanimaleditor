...
export const PERK_GROUPS: PerkGroup[] = [
  ...
  },
  {
    ...
    perks: [
      ...
      "BANK_LOAN_TERM_1",
      "BANK_LOAN_TERM_2",
      "BANK_LOAN_REFINANCING",
      "BANK_LOAN_MICROLOAN",
      "BANK_LOAN_COOLDOWN_REDUCTION",
      "CASH_FLOW_1",
      "CASH_FLOW_2",
      "QUARTERLY_REPORT_CASH_1",
      "QUARTERLY_REPORT_CASH_2",
      "QUARTERLY_REPORT_CASH_3",
      "TAX_BASE_REDUCTION_1",
      "TAX_BASE_REDUCTION_2",
      "TAX_BASE_REDUCTION_3",
      ...
      "FOCUS_QLT_1",
      "FOCUS_QLT_2",
      "FOCUS_INHOUSE_RED_TIME_1",
      "FOCUS_INHOUSE_RED_PRICE_1",
      "IP_HYPE",
      "IP_HYPE_RED_TIME_1",
      "IP_HYPE_RED_PRICE_1",
      "IP_KEEPER",
      "IP_CONTRACT_WEIGHT",
      "IP_TALANTS_LNT_BONUS_XP",
      "IP_MOVIE_THEATRE_CHEAP",
      "START_PROD_NO_ACT",
    ],
  },
  {
