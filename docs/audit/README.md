...
| G6 | Competitors | Tab is blank when `competitorStudios: {}` — common even in late game; no way to create entries for studios not yet interacted with | [competitors.md](competitors.md) | ✅ Fixed — all 5 studios shown; Create Entry inserts full 19-field default |
